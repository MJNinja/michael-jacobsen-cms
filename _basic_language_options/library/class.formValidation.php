...
class formValidation{
	...
	//VALIDATE CMS USER PASSWORD
	function validateCMSUserPassword($value, $postName, $min){
	...
	function errorSigninMessage() {
		if(count($this->errors) > 1) {
			$message = "There were ".count($this->errors)." errors signing you in!\n";
		} else {
	...
	function errorVerifyAccountMessage() {
		if(count($this->errors) > 1) {
			$message = "There were ".count($this->errors)." errors verifying your account!\n";
		} else {
	...
	function errorCMSMessage() {
		if(count($this->errors) > 1) {
			$message = "There were ".count($this->errors)." errors!\n";
		} else {
	...
	function errorCommentMessage() {
		if(count($this->errors) > 1) {
			$message = "There were ".count($this->errors)." errors submitting your comment!\n";
		} else {
