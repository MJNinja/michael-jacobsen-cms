...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'software-manager/" title="Software Manager">Software Manager</a> | <span class="current">Add Software</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Software</h1>
        <div class="intro">
        	<p>This is the <b>Add Software</b> page. This page will allow you to add a new Software.</p>
        </div>

        <div class="left-column">
        	<!-- BEGIN PARAGRAPH HOLDER-->
            <div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Add Software</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Please fill out all the required field below to add a new software. <span class="required">(*) Required</span><br />
                	Once you are done click on <b>Add Software</b> to add the new software.
                </div>
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
						...
						<input type="text" name="software-name" placeholder="Software Name" value="<?php if($_POST['software-name'] != ''){echo $_POST['software-name'];}?>" maxlength="150" />
						...
						<input type="text" name="software-link" placeholder="Software Link" value="<?php if($_POST['software-link'] != ''){echo $_POST['software-link'];}?>" />
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                	<div class="module-form-titles">Software Image</div>
                	<p>
				...
				<input type="submit" class="module-form-submit" name="add_software" title="Add Software" value="Add Software" onclick="pleasewait()" />
			</form>
