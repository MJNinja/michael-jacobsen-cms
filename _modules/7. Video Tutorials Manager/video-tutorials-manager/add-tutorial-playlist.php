...
$pageTitle = 'Add Tutorial Playlist';
...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'video-tutorials-manager/" title="Video Tutorials Manager">Video Tutorials Manager</a> | <span class="current">Add Tutorial Playlist</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Tutorial Playlist</h1>
        <div class="intro">
        	<p>This is the <b>Add Tutorial Playlist</b> page. This page will allow you to create a new Video Tutorial Playlist.</p>
        </div>

        <div class="left-column">
        	<!-- BEGIN PARAGRAPH HOLDER-->
            <div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Add Tutorial Playlist</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Please fill out all the required field below to add a new tutorial playlist. <span class="required">(*) Required</span><br />
                	Once you are done click on <b>Add Tutorial Playlist</b> to add the new tutorial playlist.
                </div>
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    ...
                    <div class="module-form-holder">
						...
						<input type="text" name="playlist-name" placeholder="Video Tutorial Playlist Name" value="<?php if($_POST['playlist-name'] != ''){echo $_POST['playlist-name'];}?>" maxlength="150" />
                        ...
                        <div class="module-date-input">
                            ...
                            <ul id="category_tags">
                                <?php if($_POST['categories'] != ''){ echo $videoTutorialManager->generatePostedTags($_POST['categories']);}?>
                            </ul>
                        ...
                        <div class="module-time-input">
                            ...
                            <ul id="software_tags">
                                <?php if($_POST['required-softwares'] != ''){ echo $videoTutorialManager->generatePostedTags($_POST['required-softwares']);}?>
                            </ul>
						...
						<div class="module-date-input">
                            ...
                            <ul id="affiliate_tags">
                                <?php if($_POST['affiliates'] != ''){ echo $videoTutorialManager->generatePostedTags($_POST['affiliates']);}?>
                            </ul>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                    ...
                    <input type="text" name="owner-website-name" placeholder="Website Name" value="<?php if($_POST['owner-website-name'] != ''){echo $_POST['owner-website-name'];}?>" />
                    <i>This is the name of the website of the original owner.</i>

                    <div class="module-form-titles">Website Link:</div>
                    <input type="text" name="owner-website-link" placeholder="Website Link" value="<?php if($_POST['owner-website-link'] != ''){echo $_POST['owner-website-link'];}?>" />
            ...
            <div class="module-holder">
				...
				<input type="submit" class="module-form-submit" name="add_tutorial_playlist" title="Add Tutorial Playlist" value="Add Tutorial Playlist" onclick="pleasewait()" />
			</form>
