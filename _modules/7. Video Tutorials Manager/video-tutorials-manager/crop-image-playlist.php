...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Video Tutorials Manager | Add Tutorial Playlist | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $videoTutorialManager->getPlaylistInfo($videoTutPlaylistID, 'videoTutPlaylistTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Crop Image</b> page. On this page you will have to crop the image for the current playlist so that it fits perfectly on the website.</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-holder-intro">
                	...
                	<input type="submit" class="module-form-submit" name="crop_playlist" title="Crop Image" value="Crop Image" onclick="pleasewait()"/>
            	</form>
            </div>
