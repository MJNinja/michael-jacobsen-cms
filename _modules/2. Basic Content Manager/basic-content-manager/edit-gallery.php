...
if(isset($_POST['basicPagesGalleryID'])){$basicPagesGalleryID = $_POST['basicPagesGalleryID'];}else{$basicPagesGalleryID = $_GET['basicPagesGalleryID'];}
...
if($pageID != '' && $basicPagesGalleryID != ''){
    ...
    if($basicContentManager->checkPageGalleryDatabase($basicPagesGalleryID) == 'not found'){
		header("Location:".$cms_root."basic-content-manager/");
		exit;
	}
}else{
...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'basic-content-manager/" title="Basic Content Manager">Basic Content Manager</a> | <a href="'.$cms_root.'basic-content-manager/manage-pages.php?pageID='.$pageID.'" title="Manage Page Content">Manage Page Content</a> | <span class="current">Edit Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Edit Gallery - <?php echo $basicContentManager->getPageInfo($pageID, 'pageName'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Edit Gallery</b> page. This page will allow you to edit the current gallery (<?php echo $basicContentManager->getPageInfo($pageID, 'pageName'); ?>).</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" id="multi-image-upload">
                    <div class="module-form-holder">
                        ...
                        <input type="hidden" name="basicPagesGalleryID" value="<?php echo $basicPagesGalleryID; ?>"/>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                    ...
                    <?php echo $basicContentManager->getPageGalleryImages($basicPagesGalleryID, $web_root);?>
			...
			<div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Page Gallery Info</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	...
                	<table width="100%" class="edit-information-table">
                      <tr>
                        <td width="50%">
                            ...
                            <?php echo $basicContentManager->getUsersName($basicContentManager->getGalleryInfo($basicPagesGalleryID, 'createdBy'));?>
                       </td>
                        <td width="50%">
                        	<div class="edit-information-table-label"><b>Modified By:</b></div>
                            <?php
                            	if($basicContentManager->getGalleryInfo($basicPagesGalleryID, 'modifiedBy') != 0){
									echo $basicContentManager->getUsersName($basicContentManager->getGalleryInfo($basicPagesGalleryID, 'modifiedBy'));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        <td>
                        	...
                        	<?php echo date("j F Y",strtotime($basicContentManager->getGalleryInfo($basicPagesGalleryID, 'createdDate')));?>
                        </td>
                        <td>
                        	<div class="edit-information-table-label"><b>Last Modified Date:</b></div>
                        	<?php
                            	if($basicContentManager->getGalleryInfo($basicPagesGalleryID, 'modifiedDate') != 0){
									echo date("j F Y", strtotime($basicContentManager->getGalleryInfo($basicPagesGalleryID, 'modifiedDate')));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<?php echo $basicContentManager->getGalleryInfo($basicPagesGalleryID, 'modifiedNumber');?>
                        </td>
                      </tr>
                    </table>
