...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'basic-content-manager/" title="Basic Content Manager">Basic Content Manager</a> | <a href="'.$cms_root.'basic-content-manager/manage-pages.php?pageID='.$pageID.'" title="Manage Page Content">Manage Page Content</a> | <span class="current">Add Paragraph</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Paragraph - <?php echo $basicContentManager->getPageInfo($pageID, 'pageName'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Add Paragraph</b> page. This page will allow you to add a new paragraph to the current page (<?php echo $basicContentManager->getPageInfo($pageID, 'pageName'); ?>).</p>
        </div>
