...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Basic Content Manager | Manage Page Content | Add Paragraph | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $basicContentManager->getPageInfo($pageID, 'pageName'); ?></h1>
        <div class="intro">
