...
if($_SESSION['cmsEditProductSubCategory'] == ''){
	$_SESSION['cmsEditProductSubCategory'] = date('Y-m-d H:i:s');
}

//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'product-manager/" title="Product Manager">Product Manager</a> | <a href="'.$cms_root.'product-manager/manage-product-category.php" title="Manage Product Categories">Manage Product Categories</a> | <span class="current">Edit Product Sub Category</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Edit Product Sub Category</h1>
        <div class="intro">
        	<p>This is the <b>Edit Product Sub Category</b> page. This page will allow you to edit an existing Product Sub Category.</p>
        </div>

        <div class="left-column">
            <div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Edit Product Sub Category</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Please change all the required field below to edit the Product Sub Category. <span class="required">(*) Required</span><br />
                	Once you are done click on <b>Edit Product Sub Category</b> to edit the sub category.
                </div>
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
                        ...
                        <div class="module-form-titles"><span class="required">*</span> Product Main Category:</div>
						<select name="product-main-category">
                            <option value="0">-- Select Product Main Category --</option>
                            <?php
                                if($_POST['product-main-category'] != ''){
                                    $mainCatID  = $_POST['product-main-category'];
                                }else{
                                    $mainCatID  = $productManager->getCategoryInfo($productCatID, 'productMainCatID');
                                }
                                echo $productManager->getProductCategories($mainCatID);
                            ?>
                        </select>
                        <i>Please select the product main category this product sub category will fall under.</i>
                    </div>
            </div>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                	<div class="module-form-titles">Product Sub Category Image</div>
                	<p>
                        An image has to be linked to the Product Sub Category by completing the fields below, please note that when the image is uploaded you will be required to crop the image after the Product Sub Category has been uploaded.
                        <br/><br/>
                ...
                <input type="submit" class="module-form-submit" name="edit_product_sub_category" title="Edit Product Sub Category" value="Edit Product Sub Category" onclick="pleasewait()"/>
            </form>
            </div>
            <!-- END IMAGE HOLDER-->

			<div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Product Sub Category Info</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Below you can see some information about the current <b>Product Sub Category</b>.
                </div>
