...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Product Manager |  Manage Product Categories | Add Product Category | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $productManager->getCategoryInfo($productCatID, 'categoryName');?></h1>
        <div class="intro">
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-holder-intro">
                	...
                	<input type="submit" class="module-form-submit" name="crop-category" title="Crop Image" value="Crop Image" onclick="pleasewait()"/>
            	</form>
            </div>
