...
if(isset($_POST['productContentID'])){$productContentID = $_POST['productContentID'];}else{$productContentID = $_GET['productContentID'];}
...
//REDIRECT PAGE
if($productID != '' && $productContentID != ''){
	//CHECK productID AND productContentID INSIDE DATABASE
	if($productManager->checkProductContentDatabase($productID, $productContentID) == 'not found'){
...
if($_SESSION['cmsEditProductParagraph'] == ''){
	$_SESSION['cmsEditProductParagraph'] = date('Y-m-d H:i:s');
}

//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'product-manager/" title="Product Manager">Product Manager</a> | <a href="'.$cms_root.'product-manager/manage-product.php?productID='.$productID.'" title="Manage Product">Manage Product</a> | <span class="current">Edit Paragraph</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Edit Paragraph - <?php echo $productManager->getProductInfo($productID, 'productTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Edit Paragraph</b> page. This page will allow you to edit the current paragraph of the current product (<?php echo $productManager->getProductInfo($productID, 'productTitle');?>).</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
                        ...
                        <input type="hidden" name="productContentID" value="<?php echo $productContentID;?>"/>
						<input type="hidden" name="oldImage" value="<?php echo $productManager->getProductContentInfo($productContentID, 'imageFile');?>"/>
						<input type="hidden" name="oldDocument" value="<?php echo $productManager->getProductContentInfo($productContentID, 'documentFile');?>"/>

                    	<div class="module-form-titles">Paragraph Title:</div>
						<input type="text" name="paragraph-title" placeholder="Paragraph Title" value="<?php if($_POST['paragraph-title'] != ''){echo $_POST['paragraph-title'];}else{echo $productManager->getProductContentInfo($productContentID, 'paragraphTitle');}?>" maxlength="150" />
						...
						<textarea name="paragraph" cols="20" rows="5"><?php if($_POST['paragraph'] != ''){echo $_POST['paragraph'];}else{echo $productManager->getProductContentInfo($productContentID, 'paragraph');}?></textarea>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                    ...
                    <?php echo $productManager->getProductContentImage($productContentID, $web_root); ?>

                    <div class="module-form-titles">Image Title:</div>
                    <input type="text" name="image-title" placeholder="Image Title" value="<?php if($_POST['image-title'] != ''){echo $_POST['image-title'];}else{echo $productManager->getProductContentInfo($productContentID, 'imageTitle');}?>" maxlength="150" />
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                	...
                	<?php echo $productManager->getProductContentDocument($productContentID, $web_root); ?>

                    <div class="module-form-titles">Document Title:</div>
                    <input type="text" name="doc-title" placeholder="Document Title" value="<?php if($_POST['doc-title'] != ''){echo $_POST['doc-title'];}else{echo $productManager->getProductContentInfo($productContentID, 'documentTitle');}?>" maxlength="150" />
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
                        ...
                        <div>
                           ...
                           <?php echo $productManager->getProductContentVideo($productContentID); ?>

						</div>
						<input type="text" name="youtube-vimeo-video" cols="20" rows="5" placeholder="YouTube/Vimeo Video" value="<?php if($_POST['youtube-vimeo-video'] != ''){echo $_POST['youtube-vimeo-video'];}else{echo $productManager->getProductContentInfo($productContentID, 'videoUrl');}?>" />
			...
			<div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Product Paragraph Info</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Below you can see some information about the current <b>Product Paragraph</b>.
                </div>
                	...
                	<table width="100%" class="edit-information-table">
                      <tr>
                        <td width="50%">
                            ...
                            <?php echo $productManager->getUsersName($productManager->getParagraphInfo($productContentID, 'createdBy'));?>
                       </td>
                        <td width="50%">
                        	<div class="edit-information-table-label"><b>Modified By:</b></div>
                            <?php
                            	if($productManager->getParagraphInfo($productContentID, 'modifiedBy') != 0){
									echo $productManager->getUsersName($productManager->getParagraphInfo($productContentID, 'modifiedBy'));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        <td>
                        	...
                        	<?php echo date("j F Y",strtotime($productManager->getParagraphInfo($productContentID, 'createdDate')));?>
                        </td>
                        <td>
                        	<div class="edit-information-table-label"><b>Last Modified Date:</b></div>
                        	<?php
                            	if($productManager->getParagraphInfo($productContentID, 'modifiedDate') != 0){
									echo date("j F Y", strtotime($productManager->getParagraphInfo($productContentID, 'modifiedDate')));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<?php echo $productManager->getParagraphInfo($productContentID, 'modifiedNumber');?>
                        </td>
                      </tr>
                    </table>
