...
if($_SESSION['cmsEditProductGallery'] == ''){
	$_SESSION['cmsEditProductGallery'] = date('Y-m-d H:i:s');
}

//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'product-manager/" title="Product Manager">Product Manager</a> | <a href="'.$cms_root.'product-manager/manage-product.php?productID='.$productID.'" title="Manage Product">Manage Product</a> | <span class="current">Edit Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Edit Gallery - <?php echo $productManager->getProductInfo($productID, 'productTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Edit Gallery</b> page. This page will allow you to edit the current gallery (<?php echo $productManager->getProductInfo($productID, 'productTitle');?>).</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" id="multi-image-upload">
                    <div class="module-form-holder">
                        ...
                        <input type="hidden" name="productGalleryID" value="<?php echo $productGalleryID; ?>"/>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                    ...
                    <?php echo $productManager->getProductGalleryImages($productGalleryID, $web_root);?>
			...
			<div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Product Gallery Info</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Below you can see some information about the current <b>Product Gallery</b>.
                </div>
                	...
                	<table width="100%" class="edit-information-table">
                      <tr>
                        <td width="50%">
                            ...
                            <?php echo $productManager->getUsersName($productManager->getGalleryInfo($productGalleryID, 'createdBy'));?>
                       </td>
                        <td width="50%">
                        	<div class="edit-information-table-label"><b>Modified By:</b></div>
                            <?php
                            	if($productManager->getGalleryInfo($productGalleryID, 'modifiedBy') != 0){
									echo $productManager->getUsersName($productManager->getGalleryInfo($productGalleryID, 'modifiedBy'));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        <td>
                        	...
                        	<?php echo date("j F Y",strtotime($productManager->getGalleryInfo($productGalleryID, 'createdDate')));?>
                        </td>
                        <td>
                        	<div class="edit-information-table-label"><b>Last Modified Date:</b></div>
                        	<?php
                            	if($productManager->getGalleryInfo($productGalleryID, 'modifiedDate') != 0){
									echo date("j F Y", strtotime($productManager->getGalleryInfo($productGalleryID, 'modifiedDate')));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<?php echo $productManager->getGalleryInfo($productGalleryID, 'modifiedNumber');?>
                        </td>
                      </tr>
                    </table>
