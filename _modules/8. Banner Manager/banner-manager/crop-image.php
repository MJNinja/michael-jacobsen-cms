...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Banner Manager | Manage Banner | Add Banner | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $bannerManager->getBannerAreaInfo($bannerAreaID, 'bannerAreaName'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Crop Image</b> page. On this page you will have to crop the banner image so that it fits perfectly on the website.</p>
        </div>
