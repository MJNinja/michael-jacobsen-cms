...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'blog-manager/" title="Blog Manager">Blog Manager</a> | <a href="'.$cms_root.'blog-manager/manage-blog-post.php?blogPostID='.$blogPostID.'" title="Manage Blog Post">Manage Blog Post</a> | <span class="current">Add Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Gallery - <?php echo $blogManager->getBlogPostInfo($blogPostID, 'blogPostTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Add Gallery</b> page. This page will allow you to add a new gallery to the current blog post (<?php echo $blogManager->getBlogPostInfo($blogPostID, 'blogPostTitle');?>).</p>
        </div>
