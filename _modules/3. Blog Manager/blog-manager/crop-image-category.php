...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Blog Manager |  Manage Blog Categories | Add Blog Category | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $blogManager->getCategoryInfo($blogCatID, 'categoryName');?></h1>
        <div class="intro">
