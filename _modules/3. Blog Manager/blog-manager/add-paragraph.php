...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'blog-manager/" title="Blog Manager">Blog Manager</a> | <a href="'.$cms_root.'blog-manager/manage-blog-category-content.php?blogCatID='.$blogCatID.'" title="Manage Blog Category">Manage Blog Category</a> | <a href="'.$cms_root.'blog-manager/manage-blog-post.php?blogPostID='.$blogPostID.'&blogCatID='.$blogCatID.'" title="Manage Blog Post">Manage Blog Post</a> | <span class="current">Add Paragraph</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Paragraph - <?php echo $blogManager->getBlogPostInfo($blogPostID, 'blogPostTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Add Paragraph</b> page. This page will allow you to add a new paragraph to the current blog post (<?php echo $blogManager->getBlogPostInfo($blogPostID, 'blogPostTitle');?>).</p>
        </div>
