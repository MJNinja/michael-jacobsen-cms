...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'blog-manager/" title="Blog Manager">Blog Manager</a> | <a href="'.$cms_root.'blog-manager/manage-blog-post.php?blogPostID='.$blogPostID.'" title="Manage Blog Post">Manage Blog Post</a> | <span class="current">Edit Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Edit Gallery - <?php echo $blogManager->getBlogPostInfo($blogPostID, 'blogPostTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Edit Gallery</b> page. This page will allow you to edit the current gallery (<?php echo $blogManager->getBlogPostInfo($blogPostID, 'blogPostTitle');?>).</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" id="multi-image-upload">
                    <div class="module-form-holder">
                        ...
                        <input type="hidden" name="blogPostGalleryID" value="<?php echo $blogPostGalleryID; ?>"/>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                    ...
                    <?php echo $blogManager->getBlogGalleryImages($blogPostGalleryID, $web_root);?>
			...
			<div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Blog Post Gallery Info</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	...
                	<table width="100%" class="edit-information-table">
                      <tr>
                        <td width="50%">
                            ...
                            <?php echo $blogManager->getUsersName($blogManager->getGalleryInfo($blogPostGalleryID, 'createdBy'));?>
                       </td>
                        <td width="50%">
                        	<div class="edit-information-table-label"><b>Modified By:</b></div>
                            <?php
                            	if($blogManager->getGalleryInfo($blogPostGalleryID, 'modifiedBy') != 0){
									echo $blogManager->getUsersName($blogManager->getGalleryInfo($blogPostGalleryID, 'modifiedBy'));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        <td>
                        	...
                        	<?php echo date("j F Y",strtotime($blogManager->getGalleryInfo($blogPostGalleryID, 'createdDate')));?>
                        </td>
                        <td>
                        	<div class="edit-information-table-label"><b>Last Modified Date:</b></div>
                        	<?php
                            	if($blogManager->getGalleryInfo($blogPostGalleryID, 'modifiedDate') != 0){
									echo date("j F Y", strtotime($blogManager->getGalleryInfo($blogPostGalleryID, 'modifiedDate')));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<?php echo $blogManager->getGalleryInfo($blogPostGalleryID, 'modifiedNumber');?>
                        </td>
                      </tr>
                    </table>
