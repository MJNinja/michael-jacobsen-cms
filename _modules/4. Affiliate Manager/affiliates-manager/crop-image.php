...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Affiliates Manager | Manage Affiliate Category | Add Affiliate Link | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $affiliatesManager->getCategoryInfo($affCatID, 'affCatName');?></h1>
        <div class="intro">
        	<p>This is the <b>Crop Image</b> page. On this page you will have to crop the image for the current affiliate link so that it fits perfectly on the website.</p>
        </div>
