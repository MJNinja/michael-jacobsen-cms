...
if($pageID != ''){
	...
	if($formsManager->checkPageIDDatabase($pageID) == 'not found'){
...
?>
    ...
    <div class="content-holder">$formsManager

    	<h1 align="center">Manage Page Content - <?php echo $formsManager->getPageInfo($pageID, 'pageName'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Manage Page Content</b> page. This page will allow you to add content to the current page (<?php echo $formsManager->getPageInfo($pageID, 'pageName'); ?>).</p>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-architecture-table-holder" id="sortable">
                    ...
                    <?php echo $formsManager->pageContentArchitecture($cms_root, $web_root, $pageID);?>
