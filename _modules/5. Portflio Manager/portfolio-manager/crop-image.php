...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Portfolio Manager | Manage Website Content | Add Paragraph | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $portfolioManager->getWebsiteInfo($portfolioID, 'websiteName');?></h1>
        <div class="intro">
