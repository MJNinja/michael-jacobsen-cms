...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Portfolio Manager | Add Website | Crop Image';
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-holder-intro">
                	...
                	<input type="submit" class="module-form-submit" name="crop-website" title="Crop Image" value="Crop Image" onclick="pleasewait()"/>
            	</form>
            </div>
