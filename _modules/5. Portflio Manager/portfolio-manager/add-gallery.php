...
//CHECK IF A GALLERY HAS ALREADY BEEN ADDED
if($portfolioManager->getGalleryTotal($portfolioID) != 0){
...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'portfolio-manager/" title="Portfolio Manager">Portfolio Manager</a> | <a href="'.$cms_root.'portfolio-manager/manage-website-content.php?portfolioID='.$portfolioID.'" title="Manage Page Content">Manage Website Content</a> | <span class="current">Add Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Gallery - <?php echo $portfolioManager->getWebsiteInfo($portfolioID, 'websiteName'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Add Gallery</b> page. This page will allow you to add a new gallery to the current website (<?php echo $portfolioManager->getWebsiteInfo($portfolioID, 'websiteName'); ?>).</p>
        </div>
