...
if(isset($_POST['tourContentID'])){$tourContentID = $_POST['tourContentID'];}else{$tourContentID = $_GET['tourContentID'];}
...
//REDIRECT PAGE
if($tourID != '' && $tourContentID != ''){
	//CHECK tourID AND tourContentID INSIDE DATABASE
	if($toursManager->checkTourContentDatabase($tourID, $tourContentID) == 'not found'){
...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'tours-manager/" title="Tours Manager">Tours Manager</a> | <a href="'.$cms_root.'tours-manager/manage-tour.php?tourID='.$tourID.'" title="Manage Tour">Manage Tour</a> | <span class="current">Edit Paragraph</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Edit Paragraph - <?php echo $toursManager->getTourInfo($tourID, 'tourTitle'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Edit Paragraph</b> page. This page will allow you to edit the current paragraph of the current tour (<?php echo $toursManager->getTourInfo($tourID, 'tourTitle'); ?>).</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
                        ...
                        <input type="hidden" name="tourContentID" value="<?php echo $tourContentID;?>"/>
						<input type="hidden" name="oldImage" value="<?php echo $toursManager->getTourContentInfo($tourContentID, 'imageFile');?>"/>
						<input type="hidden" name="oldDocument" value="<?php echo $toursManager->getTourContentInfo($tourContentID, 'documentFile');?>"/>

                    	<div class="module-form-titles">Paragraph Title:</div>
						<input type="text" name="paragraph-title" placeholder="Paragraph Title" value="<?php if($_POST['paragraph-title'] != ''){echo $_POST['paragraph-title'];}else{echo $toursManager->getTourContentInfo($tourContentID, 'paragraphTitle');}?>" maxlength="150" />
						...
						<textarea name="paragraph" cols="20" rows="5"><?php if($_POST['paragraph'] != ''){echo $_POST['paragraph'];}else{echo $toursManager->getTourContentInfo($tourContentID, 'paragraph');}?></textarea>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                    ...
                    <?php echo $toursManager->getTourContentImage($tourContentID, $web_root); ?>

                    <div class="module-form-titles">Image Title:</div>
                    <input type="text" name="image-title" placeholder="Image Title" value="<?php if($_POST['image-title'] != ''){echo $_POST['image-title'];}else{echo $toursManager->getTourContentInfo($tourContentID, 'imageTitle');}?>" maxlength="150" />
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                	...
                	<?php echo $toursManager->getTourContentDocument($tourContentID, $web_root); ?>

                    <div class="module-form-titles">Document Title:</div>
                    <input type="text" name="doc-title" placeholder="Document Title" value="<?php if($_POST['doc-title'] != ''){echo $_POST['doc-title'];}else{echo $toursManager->getTourContentInfo($tourContentID, 'documentTitle');}?>" maxlength="150" />
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
                        ...
                        <div>
                           ...
                           <?php echo $toursManager->getTourContentVideo($tourContentID); ?>

						</div>
						<input type="text" name="youtube-vimeo-video" cols="20" rows="5" placeholder="YouTube/Vimeo Video" value="<?php if($_POST['youtube-vimeo-video'] != ''){echo $_POST['youtube-vimeo-video'];}else{echo $toursManager->getTourContentInfo($tourContentID, 'videoUrl');}?>" />
                	...
                	<table width="100%" class="edit-information-table">
                      <tr>
                        <td width="50%">
                            ...
                            <?php echo $toursManager->getUsersName($toursManager->getParagraphInfo($tourContentID, 'createdBy'));?>
                       </td>
                        <td width="50%">
                        	<div class="edit-information-table-label"><b>Modified By:</b></div>
                            <?php
                            	if($toursManager->getParagraphInfo($tourContentID, 'modifiedBy') != 0){
									echo $toursManager->getUsersName($toursManager->getParagraphInfo($tourContentID, 'modifiedBy'));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        <td>
                        	...
                        	<?php echo date("j F Y",strtotime($toursManager->getParagraphInfo($tourContentID, 'createdDate')));?>
                        </td>
                        <td>
                        	<div class="edit-information-table-label"><b>Last Modified Date:</b></div>
                        	<?php
                            	if($toursManager->getParagraphInfo($tourContentID, 'modifiedDate') != 0){
									echo date("j F Y", strtotime($toursManager->getParagraphInfo($tourContentID, 'modifiedDate')));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<?php echo $toursManager->getParagraphInfo($tourContentID, 'modifiedNumber');?>
                        </td>
                      </tr>
                    </table>
