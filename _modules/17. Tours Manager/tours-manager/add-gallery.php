...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'tours-manager/" title="Tours Manager">Tours Manager</a> | <a href="'.$cms_root.'tours-manager/manage-tour.php?tourID='.$tourID.'" title="Manage Tour">Manage Tour</a> | <span class="current">Add Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Gallery - <?php echo $toursManager->getTourInfo($tourID, 'tourTitle'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Add Gallery</b> page. This page will allow you to add a new gallery to the current tour (<?php echo $toursManager->getTourInfo($tourID, 'tourTitle'); ?>).</p>
        </div>
