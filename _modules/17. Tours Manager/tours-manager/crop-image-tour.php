...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Tours Manager | Add Tour | Crop Image';
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-holder-intro">
                	...
                	<input type="submit" class="module-form-submit" name="crop-tour" title="Crop Image" value="Crop Image" onclick="pleasewait()"/>
            	</form>
            </div>
