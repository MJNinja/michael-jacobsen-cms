...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Tours Manager | Manage Tour | Add Paragraph | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $toursManager->getTourInfo($tourID, 'tourTitle'); ?></h1>
        <div class="intro">
