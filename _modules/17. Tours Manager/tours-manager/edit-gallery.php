...
if(isset($_POST['tourGalleryID'])){$tourGalleryID = $_POST['tourGalleryID'];}else{$tourGalleryID = $_GET['tourGalleryID'];}
...
if($tourID != '' && $tourGalleryID != ''){
    ...
    //CHECK tourGalleryID INSIDE DATABASE
    if($toursManager->checkTourGalleryDatabase($tourGalleryID) == 'not found'){
		header("Location:".$cms_root."tours-manager/");
		exit;
	}
}else{
...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'tours-manager/" title="Tours Manager">Tours Manager</a> | <a href="'.$cms_root.'tours-manager/manage-tour.php?tourID='.$tourID.'" title="Manage Tour">Manage Tour</a> | <span class="current">Edit Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Edit Gallery - <?php echo $toursManager->getTourInfo($tourID, 'tourTitle'); ?></h1>
        <div class="intro">
        	<p>This is the <b>Edit Gallery</b> page. This page will allow you to edit the current gallery (<?php echo $toursManager->getTourInfo($tourID, 'tourTitle'); ?>).</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" id="multi-image-upload">
                    <div class="module-form-holder">
                        ...
                        <input type="hidden" name="tourGalleryID" value="<?php echo $tourGalleryID; ?>"/>
            ...
            <div class="module-holder">
                <div class="module-form-holder">
                    ...
                    <?php echo $toursManager->getTourGalleryImages($tourGalleryID, $web_root);?>
			...
			<div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Tour Gallery Info</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Below you can see some information about the current <b>Tour Gallery</b>.
                </div>
                	...
                	<table width="100%" class="edit-information-table">
                      <tr>
                        <td width="50%">
                            ...
                            <?php echo $toursManager->getUsersName($toursManager->getGalleryInfo($tourGalleryID, 'createdBy'));?>
                       </td>
                        <td width="50%">
                        	<div class="edit-information-table-label"><b>Modified By:</b></div>
                            <?php
                            	if($toursManager->getGalleryInfo($tourGalleryID, 'modifiedBy') != 0){
									echo $toursManager->getUsersName($toursManager->getGalleryInfo($tourGalleryID, 'modifiedBy'));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        <td>
                        	...
                        	<?php echo date("j F Y",strtotime($toursManager->getGalleryInfo($tourGalleryID, 'createdDate')));?>
                        </td>
                        <td>
                        	<div class="edit-information-table-label"><b>Last Modified Date:</b></div>
                        	<?php
                            	if($toursManager->getGalleryInfo($tourGalleryID, 'modifiedDate') != 0){
									echo date("j F Y", strtotime($toursManager->getGalleryInfo($tourGalleryID, 'modifiedDate')));
								}else{
									echo '-';
								}
							?>
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<?php echo $toursManager->getGalleryInfo($tourGalleryID, 'modifiedNumber');?>
                        </td>
                      </tr>
                    </table>
