...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'events-manager/" title="Events Manager">Events Manager</a> | <a href="'.$cms_root.'events-manager/manage-event.php?eventID='.$eventID.'" title="Manage Event">Manage Event</a> | <span class="current">Add Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Gallery - <?php echo $eventManager->getEventInfo($eventID, 'eventTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Add Gallery</b> page. This page will allow you to add a new gallery to the current event (<?php echo $eventManager->getEventInfo($eventID, 'eventTitle');?>).</p>
        </div>
