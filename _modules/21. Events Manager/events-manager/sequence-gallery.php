...
$gallery_upload = 1;
$sequence = 1;
$sequenceTable = 'event_gallery_content';
$sequenceMainID = 'eventGalleryContentID';
...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'events-manager/" title="Events Manager">Events Manager</a> | <a href="'.$cms_root.'events-manager/manage-event.php?eventID='.$eventID.'" title="Manage Event">Manage Event</a> | <span class="current">Sequence Gallery</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Sequence Gallery - <?php echo $eventManager->getEventInfo($eventID, 'eventTitle');?></h1>
        <div class="intro">
        	<p>This is the <b>Sequence Gallery</b> page. This page will allow you to sequnce the current gallery (<?php echo $eventManager->getEventInfo($eventID, 'eventTitle');?>).</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-form-holder">
					...
					<div id="sortable">
                    	<?php echo $eventManager->getEventGalleryImagesSequencing($eventGalleryID, $web_root);?>
					</div>
