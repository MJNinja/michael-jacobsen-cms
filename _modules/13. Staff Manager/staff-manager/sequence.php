...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'staff-manager/" title="Staff Manager">Staff Manager</a> | <span class="current">Sequence Staff Members</span>';
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-form-holder">
					...
					<div id="sortable">
                    	<?php echo $staffManager->getStaffMembersSequencing($web_root);?>
					</div>
