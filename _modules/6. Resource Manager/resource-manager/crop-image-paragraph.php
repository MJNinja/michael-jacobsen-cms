...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Resource Manager | Manage Resource | Add Paragraph | Crop Image';
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-holder-intro">
                	...
                	<input type="submit" class="module-form-submit" name="crop_paragraph" title="Crop Image" value="Crop Image" onclick="pleasewait()"/>
            	</form>
            </div>
