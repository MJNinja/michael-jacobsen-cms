...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Resource Manager |  Manage Resource Categories | Add Resource Category | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $resourceManager->getCategoryInfo($resourceCatID, 'categoryName');?></h1>
        <div class="intro">
