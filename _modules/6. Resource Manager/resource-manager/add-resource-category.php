...
$colorbox = 1;
$ckeditor = 1;
$pageTitle = 'Add Resource Category';
...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'resource-manager/" title="Resource Manager">Resource Manager</a> | <a href="'.$cms_root.'resource-manager/manage-resource-category.php" title="Manage Resource Categories">Manage Resource Categories</a> | <span class="current">Add Resource Category</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Resource Category</h1>
        <div class="intro">
        	<p>This is the <b>Add Resource Category</b> page. This page will allow you to add a new Resource Category.</p>
        </div>

        <div class="left-column">
        	<!-- BEGIN PARAGRAPH HOLDER-->
            <div class="module-holder">
                <div class="module-holder-name">&nbsp;&nbsp;Add Resource Category</div>
                <div class="clear"></div>
                <div class="module-holder-intro">
                	Please fill out all the required field below to add a new resource category. <span class="required">(*) Required</span><br />
                	Once you are done click on <b>Add Resource Category</b> to add the new resource category.
                </div>
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
						...
						<input type="text" name="category-title" placeholder="Resource Category Title" value="<?php if($_POST['category-title'] != ''){echo $_POST['category-title'];}?>" maxlength="150" />
            ...
            <div class="module-holder">
				...
				<input type="submit" class="module-form-submit" name="add_resource_category" title="Add Resource Category" value="Add Resource Category" onclick="pleasewait()" />
			</form>
