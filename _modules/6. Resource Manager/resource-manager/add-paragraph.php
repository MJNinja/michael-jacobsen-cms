...
//SET BREADCRUMBS
$breadcrumbs = '<a href="'.$cms_root.'" title="Dashboard">Dashboard</a> | <a href="'.$cms_root.'resource-manager/" title="Resource Manager">Resource Manager</a> | <a href="'.$cms_root.'resource-manager/manage-resource-content.php?resourceID='.$resourceID.'" title="Manage Resource">Manage Resource</a> | <span class="current">Add Paragraph</span>';
...
?>
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Add Paragraph - <?php echo $resourceManager->getResourceInfo($resourceID, 'resourceName');?></h1>
        <div class="intro">
        	<p>This is the <b>Add Paragraph</b> page. This page will allow you to add a new paragraph to the current resource (<?php echo $resourceManager->getResourceInfo($resourceID, 'resourceName');?>).</p>
        </div>
            ...
            <div class="module-holder">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="module-form-holder">
						<input type="hidden" name="textHolder" value="<?php if($_POST['textHolder'] == 'para'){echo 'para';}elseif($_POST['textHolder'] == 'code'){echo 'code';}else{echo 'para';}?>" />
						...
						<div class="paragraph-holder" <?php if($_POST['textHolder'] == '' || $_POST['textHolder'] == 'para'){ echo 'style="display: block;"'; }else{ echo 'style="display: none;"'; } ?>>
						...
						<div class="code-holder" <?php if($_POST['textHolder'] == 'code'){ echo 'style="display: block;"'; }else{ echo 'style="display: none;"'; } ?>>
							<div class="module-form-titles"><span class="required">*</span> Code:</div>
							<textarea name="code" cols="20" rows="8"><?php if($_POST['code'] != ''){echo $_POST['code'];}?></textarea>
