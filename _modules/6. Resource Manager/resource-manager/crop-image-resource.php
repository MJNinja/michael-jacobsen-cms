...
//SET BREADCRUMBS
$breadcrumbs = 'Dashboard | Resource Manager |  Manage Resource Categories | Add Resource | Crop Image';
...
<script type="text/javascript">
  ...
  function checkCoords()
  {
    ...
    <div class="content-holder">
    	...
    	<h1 align="center">Crop Image - <?php echo $resourceManager->getResourceInfo($resourceID, 'resourceName');?></h1>
        <div class="intro">
        	<p>This is the <b>Crop Image</b> page. On this page you will have to crop the image for the current resource so that it fits perfectly on the website.</p>
        </div>
        ...
        <div class="left-column">
            ...
            <div class="module-holder">
                ...
                <div class="module-holder-intro">
                	...
                	<input type="submit" class="module-form-submit" name="crop_resource" title="Crop Image" value="Crop Image" onclick="pleasewait()"/>
            	</form>
            </div>
